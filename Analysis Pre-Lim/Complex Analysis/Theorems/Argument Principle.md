Let $f$ be meromorphic in a simply connected domain $D\subset \mathbb{C}$ and let $\gamma$ be a positively oriented, piecewise smooth, simple closed contour in $D$ such that 
